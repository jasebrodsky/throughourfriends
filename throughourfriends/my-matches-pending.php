...
<head>
  ...
  <?php  
      ...
      $like_page = like_page($fb_id);
      $EnoughFriends = enoughFriends($User_id);
  ...
  ?>
    ...
    <meta charset="utf-8">
    <title>My matches-pending  </title>
...
window.fbAsyncInit=function() {
 FB.Event.subscribe('edge.create', function(response) {
  window.location = "my-matches-pending.php";
 });
}
            ...
            <div class="row-fluid">
              <div id="top-text">
                ...
                <ul class="nav nav-tabs">
                  ...
                  <li class="active"><a href="my-matches-pending.php">Pending <?php echo $pending_match_badge; ?></a></li>
                  <li><a href="my-matches-active.php">Active <?php echo $active_match_badge; ?></a></li>
                </ul>
                <h2 class="blue pagination-centered"> <span>Here are your pending matches!</span></h2>
                <p class="blue pagination-centered">These matches have already been <strong>approved </strong> by either your friends, theirs, or the match themselves. </p>            
              </div> 
            </div> 
            <?php  
                  ...
                  if (($_SESSION['Claimed']) == true){
                    ...
                    //then check if user's matchable status is checked
                     if (($_SESSION['Matchable_status']) == true){
                      ...
                      //check if they have enough friends or liked on facebook
                        if (($like_page OR $EnoughFriends) == true){
                        
                        //then check if user has any pending matches yet. 
                         if (($_SESSION['New_pending_match']) >= '1') {
                          //include their pending matches if they have 1 or more
                          include ("my-matches-pending-inc.php");
                       

                          } else{
                          //else include empty message if they have 0 pending matches
                         include ("my-matches-pending-empty-inc.php");
                       }

                   } else{
                      //else include empty message if they have 0 pending matches
                     include ("my-matches-no-friends-inc.php");
                   }
                } else {
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-footer">
    ...
    <script src="assets/js/my-matches-pending.js"></script> 
