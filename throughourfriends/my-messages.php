...
<head>
  ...
  <?php  
      ...
      $my_messages = get_messages(0, 10, 'incoming');
            ...
            <div class="row">
              <div id="top-text">
                ...
                <ul class="nav nav-tabs">
                  <li class="active"><a href="my-messages.php">Incoming <?php echo $message_badge; ?> </a></li>
                  <li><a href="my-messages-sent.php">Sent</a></li>
                </ul>

                <h2 class="blue pagination-centered"> <span>View your incoming messages</span></h2>
              </div> 
            </div> 
                      ...
                      if (($_SESSION['Matchable_status']) == true){
                          //then, check if user has any incoming messages yet. 
                           if ((count_records('incoming_messages', $User_id)) == false){
                            ...
                            include ("my-messages-empty-inc.php");
                         } 
                      }
                      ?>
...
<div id="myModal" class="modal hide fade big-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div id="message_from"class="row-fluid">
      <div class="span12">
        <div class="hidden-phone span2">
          <img class='main-profile-pic' userid = "" id="message_pic_from_modal" src=""> </img>
        </div>
        <div class="well span10" style='margin-top:0%;'>
          <div class="row-fluid">
            ...
            <div style="margin-top: 10px;" class="text-align-right span4 offset2">
              <span id="message_date_modal">Now </span>
            </div>
            <div class="row-fluid">
  ...
  <div class="modal-footer">
    ...
    <a id="reply_button" aria-hidden="true" href="#" class="btn btn-primary">Reply</a>
  </div>
</div>
...
<div id="compose-modal" class="modal hide fade big-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div id="modal-footer"class="modal-footer">
    ...
    <script src="assets/js/my-messages.js"></script>
